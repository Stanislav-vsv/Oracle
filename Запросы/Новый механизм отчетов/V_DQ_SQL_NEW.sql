DROP VIEW MONITORING.V_DQ_SQL_NEW;

/* Formatted on 30.05.2013 16:38:23 (QP5 v5.163.1008.3004) */
CREATE OR REPLACE FORCE VIEW MONITORING.V_DQ_SQL_NEW
(
   LIST_ID,
   SQL_TEXT
)
AS
   SELECT list_id,
          ...
          || list_id
          || ' and REV_ID in (SELECT REV_ID FROM V_DQ_GET_REV_ID_NEW)'
             AS sql_text

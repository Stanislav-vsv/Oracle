...
with
 ...
 select bal_aktiv, bal_passiv, delta, dlt,  round(abs(bal_aktiv-bal_passiv),4) - dlt.dlt as delta_dlt, dealvalue_day
 from
     (                  
         select bal_aktiv, bal_passiv, round(abs(bal_aktiv-bal_passiv),4) delta, t1.dealvalue_day
         from 

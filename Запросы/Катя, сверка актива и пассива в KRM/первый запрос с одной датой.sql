...
with
 aa as(
            ...
            * from dmout.krmportfldb_dmout 
            where dealvalue_day=to_date('18.06.2014','dd.mm.yyyy')),
 ...
 rate_usd as(
                    ...
                    on CH1.UK=ES.CURRENCY_TO_UK
                     where es.value_day=to_date('18062014','ddmmyyyy')
 ...
 cc as (
             select bb.account2, bb.dealvalue_day,
                      case when bb.currency='EUR' then (bb.cur_bk_bal*(rate_eur.rate/rate_usd.rate))  when bb.currency='RUR' then (bb.cur_bk_bal*(1/rate_usd.rate)) else (bb.cur_bk_bal)  end cur_bk_bal   
